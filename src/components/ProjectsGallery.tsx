...
export const ProjectsGallery: React.FC<ProjectsGalleryProps> = ({ onSelectProject }) => {
  ...
  return (
    <section id="works-section" className="py-24 sm:py-32 bg-[#08090C] relative">
                      ...
                      <div className="flex items-center gap-2.5">
                        {project.externalLinks?.liveSite && (
                          <a
                            ...
                            className="inline-flex items-center gap-1.5 px-4 py-2.5 rounded-full bg-white/[0.06] hover:bg-white/12 text-white text-sm font-sans font-medium transition-all active:scale-95 border border-white/[0.08]"
                          >
